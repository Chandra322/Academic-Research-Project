...
<head>
    ...
    <title>Home || Researcher</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="assets/images/favicon.ico">
     <link rel="apple-touch-icon" sizes="180x180" href="/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="31x31" href="/favicon-31x31.png">
                                ...
                                <div class="main-menu">
                                    <nav class="main-navigation">
                                        <ul>
                                            ...
                                            <li>LOGIN
                                                <ul class="sub-menu">
                                                    <li><a href="adminLogin">PUBLISHER LOGIN</a></li>
                                                    <li><a href="studentLoginRegister">RESEARCHER LOGIN</a></li>
                                                    <li><a href="clubheadlogin">CLIENT</a></li>
                                                </ul>
                                            </li>
        ...
        <div class="hero-slider">
            ...
            <div class="hero-slider-active owl-carousel">
                ...
                <div class="singleSlide" data-black-overlay="3">
                    <div class="itemBg">
                        <img src="assets/images/slider/Achieve1.jpg" alt="">
                    </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="slider-text-info">
                                        <h1><span>Research</span> <br> From Anywhere </h1>
<!--                                         <a href="about.html" class="btn slider-btn uppercase"><span>About us</span></a> -->
                ...
                <div class="singleSlide" data-black-overlay="3">
                    <div class="itemBg">
                        <img src="assets/images/slider/ach3.jpg" alt="">
                    </div>
                    <!-- Hero Content One Start -->
                    <div class="container">
                        <div class="hero-content-one">
...
<!--                                         <a href="about.html" class="btn slider-btn uppercase"><span>About us</span></a> -->
                ...
                <div class="singleSlide" data-black-overlay="3">
                    <div class="itemBg">
                        <img src="assets/images/slider/ach4.jpg" alt="">
                    </div>
                    <!-- Hero Content One Start -->
                    <div class="container">
                        <div class="hero-content-one">
                ...
                <div class="row">
                    <div class="col-lg-10 m-auto">
                        ...
                        <div class="section-title-three">
                            <h4>WELCOME TO RESEARCHER</h4>
                            <h3>Our Main Aim</h3>
                            <p> To create a platform for ease of access of Journals, Articles and Researches</p>
                        </div>
                        <!--// section-title -->
                    </div>
                </div>
                        ...
                        <div class="course-categories-wrap">
                                ...
                                <div class="single-course-categories malachite">
                                    <div class="item-inner">
                                        <div class="cours-icon">
                                            <img src="assets/images/icon/favicon.ico" alt="">
                                        </div>
                            ...
                            <div class="coustom-col-3">
                                ...
                                <div class="single-course-categories sunglow">
                                    <div class="item-inner">
                                        <div class="cours-icon">
                                            <img src="assets/images/icon/certificateupload.ico" alt="">
                                        </div>
                                        <div class="cours-title">
                                            <h5>Journals</h5>
                                        </div>
                            ...
                            <div class="coustom-col-3">
                                ...
                                <div class="single-course-categories mariner">
                                    <div class="item-inner">
                                        <div class="cours-icon">
                                            <img src="assets/images/icon/position.ico" alt="">
                                        </div>
                                        <div class="cours-title">
                                            <h5>Blogs</h5>
                                        </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="single-choose-service text-center mt--30">
                            ...
                            <div class="service-content">
                                <h4>Journals</h4>
                                <p>A newspaper or magazine that deals with a particular subject or professional activity.</p>
                            </div>
                        </div>
                        <!--// single-choose-service -->
                    </div>
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="single-choose-service text-center mt--30">
                            ...
                            <div class="service-content">
                                <h4>Articles</h4>
                                <p>A piece of writing included with others in a newspaper, magazine, or other print or online publication.</p>
                            </div>
                        </div>
                        <!--// single-choose-service -->
                    </div>
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="single-choose-service text-center mt--30">
                            ...
                            <div class="service-content">
                                <h4>Publications</h4>
                                <p>the preparation and issuing of a book, journal, or piece of music for public sale</p>
                            </div>
                        </div>
                        <!--// single-choose-service -->
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="copy-right pt--10 pb--10 text-center text-white">
                                <p>Copyright© 2022 <a href="#">Researcher</a>,Designed by <span> K.L University Students</span></p>
                            </div>
                        </div>
                    </div>
                </div>
